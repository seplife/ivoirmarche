...
const products = [
  { 
    ...
    type: 'meditation',
    goal: 'stress-relief', 
    image: 'https://via.placeholder.com/250x250?text=Kit+Méditation' 
  },
  { 
    id: 2, 
  ...
  { 
    ...
    type: 'aromatherapy',
    goal: 'relaxation', 
    image: 'https://via.placeholder.com/250x250?text=Huiles+Essentielles' 
  },
  { 
    id: 4, 
    name: 'Appareil de Fitness Compact', 
    price: 159.99, 
    type: 'fitness',
    goal: 'energy', 
    image: 'https://via.placeholder.com/250x250?text=Fitness+Compact' 
  },
  { 
    id: 5, 
    name: 'Complément Nutrition', 
    price: 29.99, 
    type: 'nutrition',
    goal: 'energy', 
    image: 'https://via.placeholder.com/250x250?text=Complément' 
  },
  { 
    id: 6, 
    name: 'Diffuseur d\'Aromathérapie', 
    price: 69.99, 
    type: 'aromatherapy',
    goal: 'relaxation', 
    image: 'https://via.placeholder.com/250x250?text=Diffuseur' 
  },
  { 
    id: 7, 
    ...
    type: 'meditation',
    goal: 'stress-relief', 
    image: 'https://via.placeholder.com/250x250?text=App+Méditation' 
  },
  { 
    id: 8, 
    name: 'Coussin de Méditation Ergonomique', 
    price: 59.99, 
    type: 'meditation',
    goal: 'mindfulness', 
    image: 'https://via.placeholder.com/250x250?text=Coussin+Méditation' 
  },
  { 
    id: 9, 
...
function applyFilters() {
  ...
  filteredProducts = products.filter(product => {
    ...
    const passGoal = !goalFilter || product.goal === goalFilter;
    const passPrice = !priceFilter || checkPriceRange(product.price, priceFilter);
    return passProductType && passGoal && passPrice;
  });
...
function renderProducts() {
  const grid = document.getElementById('bienEtreProductsGrid');
  grid.innerHTML = '';

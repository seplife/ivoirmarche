...
const products = [
  { 
    id: 1, 
    name: 'Ensemble Bébé Bio', 
    price: 34.99, 
    age: '0-6-months',
    type: 'clothing', 
    image: 'https://via.placeholder.com/250x250?text=Ensemble+Bébé' 
  },
  { 
    id: 2, 
    name: 'Jouet Éducatif Musical', 
    price: 29.99, 
    age: '6-12-months',
    type: 'toys', 
    image: 'https://via.placeholder.com/250x250?text=Jouet+Musical' 
  },
  { 
    id: 3, 
    name: 'Lit Parapluie Portable', 
    price: 99.99, 
    age: '0-6-months',
    type: 'nursery', 
    image: 'https://via.placeholder.com/250x250?text=Lit+Parapluie' 
  },
  { 
    id: 4, 
    ...
    age: '6-12-months',
    type: 'feeding', 
    image: 'https://via.placeholder.com/250x250?text=Biberon' 
  },
  { 
    id: 5, 
    ...
    age: '1-2-years',
    type: 'safety', 
    image: 'https://via.placeholder.com/250x250?text=Barrière+Sécurité' 
  },
  { 
    id: 6, 
    name: 'Peluche Interactive', 
    price: 39.99, 
    age: '2-4-years',
    type: 'toys', 
    image: 'https://via.placeholder.com/250x250?text=Peluche+Interactive' 
  },
  { 
    id: 7, 
    ...
    age: '1-2-years',
    type: 'feeding', 
    image: 'https://via.placeholder.com/250x250?text=Chaise+Haute' 
  },
  { 
    id: 8, 
    name: 'Kit de Sécurité Bébé', 
    price: 49.99, 
    age: '0-6-months',
    type: 'safety', 
    image: 'https://via.placeholder.com/250x250?text=Kit+Sécurité' 
  },
  { 
    id: 9, 
    name: 'Machine à Café Connectée', 
    price: 229.99, 
    brand: 'samsung',
    type: 'cuisine', 
    image: 'https://via.placeholder.com/250x250?text=Machine+à+Café' 
  },
  { 
    id: 10, 
    ...
    brand: 'ikea',
    type: 'storage', 
    image: 'https://via.placeholder.com/250x250?text=Étagère' 
  },
  { 
    id: 11, 
    ...
    brand: 'philips',
    type: 'smart-home', 
    image: 'https://via.placeholder.com/250x250?text=Lampe+Connectée' 
  },
  { 
    id: 12, 
    ...
    brand: 'nest',
    type: 'smart-home', 
    image: 'https://via.placeholder.com/250x250?text=Thermostat' 
  },
  { 
    id: 13, 
    ...
    brand: 'ikea',
    type: 'storage', 
    image: 'https://via.placeholder.com/250x250?text=Set+Rangement' 
  },
  { 
    id: 14, 
    ...
    brand: 'dyson',
    type: 'cleaning', 
    image: 'https://via.placeholder.com/250x250?text=Purificateur' 
  },
  { 
    id: 15, 
    ...
    brand: 'samsung',
    type: 'smart-home', 
    image: 'https://via.placeholder.com/250x250?text=Enceinte' 
  }
];
...
function applyFilters() {
  ...
  filteredProducts = products.filter(product => {
    const passAge = !ageFilter || product.age === ageFilter;
    ...
    return passAge && passProductType && passPrice;
  });
...
function renderProducts() {
  const grid = document.getElementById('enfantBebeProductsGrid');
  grid.innerHTML = '';

...
const products = [
  { 
      ...
      price: 89.99, 
      subcategory: 'femme', 
      description: 'Une robe élégante parfaite pour les grandes occasions.',
      image: 'https://via.placeholder.com/250x250?text=Robe+Élégante' 
  },
  { 
      id: 2, 
      name: 'T-shirt Casual', 
      price: 29.99, 
      subcategory: 'homme', 
      description: 'Un t-shirt confortable idéal pour un look décontracté.',
  ...
  { 
      ...
      description: 'Un sac à main en cuir haut de gamme avec une finition impeccable.',
      image: 'https://via.placeholder.com/250x250?text=Sac+à+Main' 
  },
  { 
      id: 4, 
      ...
      description: 'Des baskets légères et respirantes, idéales pour le sport.',
      image: 'https://via.placeholder.com/250x250?text=Basket+Sport' 
  },
  { 
      id: 5, 
      ...
      description: 'Un pantalon de jogging confortable et stylé pour vos séances de sport.',
      image: 'https://via.placeholder.com/250x250?text=Pantalon+Jogging' 
  },
  { 
      id: 6, 
      ...
      price: 59.99, 
      subcategory: 'homme', 
      description: 'Une chemise classique en coton pour un look professionnel.',
      image: 'https://via.placeholder.com/250x250?text=Chemise+Classique' 
  },
  { 
      id: 7, 
      name: 'Chapeau d\'été', 
      price: 34.99, 
      subcategory: 'accessoires', 
      description: 'Un chapeau léger et élégant pour se protéger du soleil avec style.',
      image: 'https://via.placeholder.com/250x250?text=Chapeau+été' 
  },
  { 
      id: 8, 
      name: 'Veste de Sport', 
      price: 89.99, 
      subcategory: 'sportswear', 
      description: 'Une veste coupe-vent idéale pour le sport en extérieur.',
      image: 'https://via.placeholder.com/250x250?text=Veste+Sport' 
  },
  { 
    id: 9, 
    name: 'T-shirt Casual', 
...
function renderProducts() {
  const grid = document.getElementById('modeProductsGrid');
  grid.innerHTML = '';
